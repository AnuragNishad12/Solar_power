...
class telan extends StatelessWidget {
  const telan({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Telangana",style: TextStyle(
          fontSize:20.0,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('telan').snapshots(),
