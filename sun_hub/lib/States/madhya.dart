...
class Madhya extends StatelessWidget {
  const Madhya({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Madhya Pradesh",style: TextStyle(
          fontSize:20.0,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('madhya').snapshots(),
