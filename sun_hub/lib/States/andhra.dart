...
class andhra extends StatefulWidget {
  const andhra({super.key});

  @override
  State<andhra> createState() => _andhraState();
}
...
class _andhraState extends State<andhra> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Andhra Pradesh",style: TextStyle(
          fontSize:20.0,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('andhra').snapshots(),
