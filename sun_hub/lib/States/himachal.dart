...
class himachal extends StatelessWidget {
  const himachal({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Himachal Pradesh",style: TextStyle(
          fontSize:20.0,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('himachal').snapshots(),
