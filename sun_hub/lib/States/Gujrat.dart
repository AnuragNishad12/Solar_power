...
class Gujrat extends StatelessWidget {
  const Gujrat({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Gujarat",style: TextStyle(
          fontSize:20.0,
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('gujarat').snapshots(),
